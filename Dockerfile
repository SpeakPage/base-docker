...
# INSTALL LIBS:
RUN apt-get install software-properties-common libavahi-client3 git python cmake gcc g++ libgroove-dev zlib1g-dev libpng12-dev sox libsox-dev libsox-fmt-all eyed3 ffmpeg mongodb-clients -y && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
